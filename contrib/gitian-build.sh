...
VERSION=
commit=false
url=https://github.com/goldcoin-project/goldcoin
proc=2
mem=2000
lxc=true
...
-u|--url	Specify the URL of the repository. Default is https://github.com/goldcoin-project/goldcoin
...
then
	# Make output folder
	mkdir -p ./goldcoin-binaries/${VERSION}
