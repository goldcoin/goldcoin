...
"QLabel { color: rgb(40,40,40);  }"));
    ...
    void retranslateUi(ModalOverlay *ModalOverlay)
    {
        ...
        infoText->setText(QCoreApplication::translate("ModalOverlay", "Recent transactions may not yet be visible, and therefore your wallet's balance might be incorrect. This information will be correct once your wallet has finished synchronizing with the goldcoin network, as detailed below.", nullptr));
        infoTextStrong->setText(QCoreApplication::translate("ModalOverlay", "Attempting to spend goldcoins that are affected by not-yet-displayed transactions will not be accepted by the network.", nullptr));
        labelNumberOfBlocksLeft->setText(QCoreApplication::translate("ModalOverlay", "Number of blocks left", nullptr));
        numberOfBlocksLeft->setText(QCoreApplication::translate("ModalOverlay", "Unknown...", nullptr));
        labelLastBlockTime->setText(QCoreApplication::translate("ModalOverlay", "Last block time", nullptr));
        newestBlockDate->setText(QCoreApplication::translate("ModalOverlay", "Unknown...", nullptr));
        ...
        progressIncreasePerH->setText(QCoreApplication::translate("ModalOverlay", "calculating...", nullptr));
        labelEstimatedTimeLeft->setText(QCoreApplication::translate("ModalOverlay", "Estimated time left until synced", nullptr));
        expectedTimeLeft->setText(QCoreApplication::translate("ModalOverlay", "calculating...", nullptr));
