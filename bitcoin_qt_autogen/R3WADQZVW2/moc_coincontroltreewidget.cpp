...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CoinControlTreeWidget_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CoinControlTreeWidget_t qt_meta_stringdata_CoinControlTreeWidget = {
    {
        QT_MOC_LITERAL(0, 21)   // "CoinControlTreeWidget"
    },
...
Q_CONSTINIT static const uint qt_meta_data_CoinControlTreeWidget[] = {
...
Q_CONSTINIT const QMetaObject CoinControlTreeWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_CoinControlTreeWidget.offsetsAndSizes,
    qt_meta_data_CoinControlTreeWidget,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CoinControlTreeWidget_t,
        // Q_OBJECT / Q_GADGET
