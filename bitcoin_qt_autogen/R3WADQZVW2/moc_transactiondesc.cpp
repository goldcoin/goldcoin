...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_TransactionDesc_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_TransactionDesc_t qt_meta_stringdata_TransactionDesc = {
    {
        QT_MOC_LITERAL(0, 15)   // "TransactionDesc"
    },
    "TransactionDesc"
};
...
Q_CONSTINIT static const uint qt_meta_data_TransactionDesc[] = {
...
Q_CONSTINIT const QMetaObject TransactionDesc::staticMetaObject = { {
    ...
    qt_meta_stringdata_TransactionDesc.offsetsAndSizes,
    qt_meta_data_TransactionDesc,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_TransactionDesc_t,
        // Q_OBJECT / Q_GADGET
