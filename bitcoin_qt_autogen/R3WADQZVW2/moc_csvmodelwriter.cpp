...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CSVModelWriter_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CSVModelWriter_t qt_meta_stringdata_CSVModelWriter = {
    {
        QT_MOC_LITERAL(0, 14)   // "CSVModelWriter"
    },
    "CSVModelWriter"
};
...
Q_CONSTINIT static const uint qt_meta_data_CSVModelWriter[] = {
...
Q_CONSTINIT const QMetaObject CSVModelWriter::staticMetaObject = { {
    ...
    qt_meta_stringdata_CSVModelWriter.offsetsAndSizes,
    qt_meta_data_CSVModelWriter,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CSVModelWriter_t,
        // Q_OBJECT / Q_GADGET
