...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_BitcoinAmountField_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_BitcoinAmountField_t qt_meta_stringdata_BitcoinAmountField = {
    {
        QT_MOC_LITERAL(0, 18),  // "BitcoinAmountField"
        QT_MOC_LITERAL(19, 12),  // "valueChanged"
        QT_MOC_LITERAL(32, 0),  // ""
        QT_MOC_LITERAL(33, 11),  // "unitChanged"
...
Q_CONSTINIT static const uint qt_meta_data_BitcoinAmountField[] = {
...
Q_CONSTINIT const QMetaObject BitcoinAmountField::staticMetaObject = { {
    ...
    qt_meta_stringdata_BitcoinAmountField.offsetsAndSizes,
    qt_meta_data_BitcoinAmountField,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_BitcoinAmountField_t,
        // property 'value'
...
void BitcoinAmountField::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &BitcoinAmountField::valueChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
