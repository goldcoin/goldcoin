...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_BitcoinUnits_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_BitcoinUnits_t qt_meta_stringdata_BitcoinUnits = {
    {
        QT_MOC_LITERAL(0, 12)   // "BitcoinUnits"
    },
    "BitcoinUnits"
};
...
Q_CONSTINIT static const uint qt_meta_data_BitcoinUnits[] = {
...
Q_CONSTINIT const QMetaObject BitcoinUnits::staticMetaObject = { {
    ...
    qt_meta_stringdata_BitcoinUnits.offsetsAndSizes,
    qt_meta_data_BitcoinUnits,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_BitcoinUnits_t,
        // Q_OBJECT / Q_GADGET
