...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_MacNotificationHandler_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_MacNotificationHandler_t qt_meta_stringdata_MacNotificationHandler = {
    {
        QT_MOC_LITERAL(0, 22)   // "MacNotificationHandler"
    },
...
Q_CONSTINIT static const uint qt_meta_data_MacNotificationHandler[] = {
...
Q_CONSTINIT const QMetaObject MacNotificationHandler::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_MacNotificationHandler.offsetsAndSizes,
    qt_meta_data_MacNotificationHandler,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_MacNotificationHandler_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<MacNotificationHandler, std::true_type>
    >,
    nullptr
} };
