...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_TransactionDescDialog_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_TransactionDescDialog_t qt_meta_stringdata_TransactionDescDialog = {
    {
        QT_MOC_LITERAL(0, 21)   // "TransactionDescDialog"
    },
...
Q_CONSTINIT static const uint qt_meta_data_TransactionDescDialog[] = {
...
Q_CONSTINIT const QMetaObject TransactionDescDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_TransactionDescDialog.offsetsAndSizes,
    qt_meta_data_TransactionDescDialog,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_TransactionDescDialog_t,
        // Q_OBJECT / Q_GADGET
