...
class WalletTest (BitcoinTestFramework):
    ...
    def run_test (self):
        ...
        assert_equal(self.nodes[2].getbalance("from1"), 19994-21)
        ...
        self.sync_all()
        node_2_bal = self.check_fee_amount(self.nodes[2].getbalance(), Decimal('19984'), fee_per_byte, count_bytes(self.nodes[2].getrawtransaction(txid)))
        ...
        outputs = {self.nodes[1].getnewaddress(): 9999.998, self.nodes[0].getnewaddress(): 11.11}
