...
class TxnMallTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Node0's balance should be starting balance, plus 10000GLD for another
        ...
        # Check node0's total balance; should be same as before the clone, + 20000 GLD for 2 matured,
