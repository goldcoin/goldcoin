...
bool PaymentRequestPlus::getMerchant(X509_STORE* certStore, QString& merchant) const
{
    ...
    for (int i = 0; i < certChain.certificate_size(); i++) {
        ...
        // Qt6: isBlacklisted() was removed, blacklisting is handled by system certificate store
        // Certificate validation is now handled by the underlying SSL implementation
#endif
