...
{
    QMessageBox::critical(nullptr, "Runaway exception", BitcoinApplication::tr("A fatal error occurred. Goldcoin can no longer continue safely and will quit.") + QString("\n\n") + message);
    ::exit(EXIT_FAILURE);
}
