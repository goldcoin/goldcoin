...
//! -maxtxfee default
static const CAmount DEFAULT_TRANSACTION_MAXFEE = 0.1 * COIN;  // 100 times default fee
...
bool CheckTransaction(const CTransaction& tx, CValidationState& state, bool isGIP1Active, bool fCheckDuplicateInputs=true);
