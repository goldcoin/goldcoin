...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-rpcserialversion", strprintf(_("Sets the serialization of raw transaction or block hex returned in non-verbose mode, currently enforced to non-segwit (0)"), DEFAULT_RPC_SERIALIZE_VERSION));
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/goldcoin-project/goldcoin>";
