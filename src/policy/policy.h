...
static constexpr unsigned int DEFAULT_BLOCK_MAX_SIZE = 32000000;
/** Default for -blockprioritysize, maximum space for zero/low-fee transactions **/
static constexpr unsigned int DEFAULT_BLOCK_PRIORITY_SIZE = DEFAULT_BLOCK_MAX_SIZE * 5 / 100; //5% are allowed to be free
/** Default for -blockmintxfee, which sets the minimum feerate for a transaction in blocks created by mining code **/
static constexpr unsigned int DEFAULT_BLOCK_MIN_TX_FEE = 1000;
/** The maximum weight (size in bytes) for transactions we're willing to relay/mine */
static constexpr unsigned int MAX_STANDARD_TX_WEIGHT = 100000;
/** Maximum number of signature check operations in an IsStandard() P2SH script */
static constexpr unsigned int MAX_P2SH_SIGOPS = 15;
/** The maximum number of sigops we're willing to relay/mine in a single tx */
static constexpr unsigned int MAX_STANDARD_TX_SIGOPS_COST = MAX_BLOCK_SIGOPS_COST/5;
/** Default for -maxmempool, maximum megabytes of mempool memory usage */
static constexpr unsigned int DEFAULT_MAX_MEMPOOL_SIZE = 320;
 ...
 */
static constexpr unsigned int STANDARD_SCRIPT_VERIFY_FLAGS_COMPAT = MANDATORY_SCRIPT_VERIFY_FLAGS |
