...
//! -mintxfee default
static constexpr CAmount DEFAULT_TRANSACTION_MINFEE = 100000;
...
static constexpr bool DEFAULT_SEND_FREE_TRANSACTIONS = false;
...
static constexpr bool DEFAULT_USE_HD_WALLET = true;
...
enum WalletFeature
{
    ...
    FEATURE_BDB18 = 170000, // Berkeley DB 18.1 native support (first crypto to achieve BDB 4.8→18.1 migration)
    FEATURE_LATEST = FEATURE_BDB18 // Updated for v0.17.0 - all new wallets use BDB 18.1 format
};
