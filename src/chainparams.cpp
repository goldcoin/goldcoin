...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-a.goldcoin.loshan.co.uk", true));
        vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        vSeeds.push_back(CDNSSeedData("goldcointools.com", "dnsseed.goldcointools.com"));
        vSeeds.push_back(CDNSSeedData("goldcoinpool.org", "dnsseed.goldcoinpool.org"));
...
public:
    CTestNetParams() {
        ...
        vSeeds.push_back(CDNSSeedData("goldcointools.com", "testnet-seed.goldcointools.com"));
        vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.goldcoin.loshan.co.uk", true));
