...
BOOST_AUTO_TEST_CASE(netbase_splithost)
{
    ...
    BOOST_CHECK(TestSplitHost("127.0.0.1:8121", "127.0.0.1", 8121));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:8121", "127.0.0.1", 8121));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:8121", "::ffff:127.0.0.1", 8121));
    BOOST_CHECK(TestSplitHost("[::]:8121", "::", 8121));
    BOOST_CHECK(TestSplitHost("::8121", "::8121", -1));
    BOOST_CHECK(TestSplitHost(":8121", "", 8121));
    BOOST_CHECK(TestSplitHost("[]:8121", "", 8121));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:8121", "127.0.0.1:8121"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:8121", "[::]:8121"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
...
BOOST_AUTO_TEST_CASE(netbase_getgroup)
{
    ...
    std::vector<unsigned char> expected_local = {0};
    BOOST_CHECK(ResolveIP("127.0.0.1").GetGroup() == expected_local); // Local -> !Routable()
    std::vector<unsigned char> expected_invalid = {0};
    BOOST_CHECK(ResolveIP("257.0.0.1").GetGroup() == expected_invalid); // !Valid -> !Routable()
    std::vector<unsigned char> expected_rfc1918 = {0};
    BOOST_CHECK(ResolveIP("10.0.0.1").GetGroup() == expected_rfc1918); // RFC1918 -> !Routable()
    std::vector<unsigned char> expected_rfc3927 = {0};
    BOOST_CHECK(ResolveIP("169.254.1.1").GetGroup() == expected_rfc3927); // RFC3927 -> !Routable()
    std::vector<unsigned char> expected_ipv4 = {(unsigned char)NET_IPV4, 1, 2};
    BOOST_CHECK(ResolveIP("1.2.3.4").GetGroup() == expected_ipv4); // IPv4
    std::vector<unsigned char> expected_rfc6145 = {(unsigned char)NET_IPV4, 1, 2};
    BOOST_CHECK(ResolveIP("::FFFF:0:102:304").GetGroup() == expected_rfc6145); // RFC6145
    std::vector<unsigned char> expected_rfc6052 = {(unsigned char)NET_IPV4, 1, 2};
    BOOST_CHECK(ResolveIP("64:FF9B::102:304").GetGroup() == expected_rfc6052); // RFC6052
    std::vector<unsigned char> expected_rfc3964 = {(unsigned char)NET_IPV4, 1, 2};
    BOOST_CHECK(ResolveIP("2002:102:304:9999:9999:9999:9999:9999").GetGroup() == expected_rfc3964); // RFC3964
    std::vector<unsigned char> expected_rfc4380 = {(unsigned char)NET_IPV4, 1, 2};
    BOOST_CHECK(ResolveIP("2001:0:9999:9999:9999:9999:FEFD:FCFB").GetGroup() == expected_rfc4380); // RFC4380
    std::vector<unsigned char> expected_tor = {(unsigned char)NET_TOR, 239};
    BOOST_CHECK(ResolveIP("FD87:D87E:EB43:edb1:8e4:3588:e546:35ca").GetGroup() == expected_tor); // Tor
    std::vector<unsigned char> expected_he_net = {(unsigned char)NET_IPV6, 32, 1, 4, 112, 175};
    BOOST_CHECK(ResolveIP("2001:470:abcd:9999:9999:9999:9999:9999").GetGroup() == expected_he_net); //he.net
    std::vector<unsigned char> expected_ipv6 = {(unsigned char)NET_IPV6, 32, 1, 32, 1};
    BOOST_CHECK(ResolveIP("2001:2001:9999:9999:9999:9999:9999:9999").GetGroup() == expected_ipv6); //IPv6
